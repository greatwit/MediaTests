 ...
 *
 * <li>If necessary, modify the returned {@link GreatCamera.Parameters} object and call
 * {@link #setParameters(GreatCamera.Parameters)}.
 *
 ...
 *
 * <li>When you want, call {@link #takePicture(GreatCamera.ShutterCallback,
 * GreatCamera.PictureCallback, GreatCamera.PictureCallback, GreatCamera.PictureCallback)} to
 ...
 *
 * <li>Pass the camera to {@link android.media.MediaRecorder#setCamera(GreatCamera)}.
 ...
 * </div>
 */
public class GreatCamera {
    private static final String TAG = "GreatCamera";
...
//        }
    ...
    public static class CameraInfo {
         ...
         * when {@link GreatCamera#takePicture takePicture} is called.</p>
         */
     ...
     */
    public static GreatCamera open(int cameraId) {
        return new GreatCamera(cameraId);
    }
     ...
     * @see #open(int)
     */
    public static GreatCamera open() {
        int numberOfCameras = getNumberOfCameras();
        CameraInfo cameraInfo = new CameraInfo();
        for (int i = 0; i < numberOfCameras; i++) {
            getCameraInfo(i, cameraInfo);
            if (cameraInfo.facing == CameraInfo.CAMERA_FACING_BACK) {
                return new GreatCamera(i);
            }
        }
        return null;
    }

    GreatCamera(int cameraId) {
        ...
        native_setup(new WeakReference<GreatCamera>(this), cameraId);
    }
     ...
     * {@link android.media.MediaRecorder#setCamera(GreatCamera)}. This cannot be
    ...
    public native final boolean isPlayingCamera();
     ...
     * they are displayed.
     *
     * @see #setPreviewCallback(GreatCamera.PreviewCallback)
     * @see #setOneShotPreviewCallback(GreatCamera.PreviewCallback)
     * @see #setPreviewCallbackWithBuffer(GreatCamera.PreviewCallback)
     * @see #startPreview()
     */
    public interface PreviewCallback
    {
         ...
         * refer to the equations in {@link GreatCamera.Parameters#setPreviewFormat}
         ...
         */
        void onPreviewFrame(byte[] data, GreatCamera camera);
    };
     ...
     *
     * <p>If {@link #setPreviewCallback(GreatCamera.PreviewCallback)},
     * {@link #setOneShotPreviewCallback(GreatCamera.PreviewCallback)}, or
     * {@link #setPreviewCallbackWithBuffer(GreatCamera.PreviewCallback)} were
     * called, {@link GreatCamera.PreviewCallback#onPreviewFrame(byte[], GreatCamera)}
     ...
     * callback, {@link #setPreviewCallback(GreatCamera.PreviewCallback)} is called,
     * or {@link #setOneShotPreviewCallback(GreatCamera.PreviewCallback)} is
     * called.</p>
     *
     * <p>If you are using the preview data to create video or still images,
     * strongly consider using {@link android.media.MediaActionSound} to
     ...
     * read from {@link GreatCamera.Parameters#getPictureSize()}. Bytes per pixel
     * can be computed from
     * {@link android.graphics.ImageFormat#getBitsPerPixel(int)} / 8,
     * using the image format from {@link GreatCamera.Parameters#getPreviewFormat()}.
     *
     * <p>This method is only necessary when the PictureCallbck for raw image
     * is used while calling {@link #takePicture(GreatCamera.ShutterCallback,
     * GreatCamera.PictureCallback, GreatCamera.PictureCallback, GreatCamera.PictureCallback)}.
     *
    ...
    {
        private GreatCamera mCamera;

        public EventHandler(GreatCamera c, Looper looper) {
            super(looper);
            mCamera = c;
        }
    ...
    {
        GreatCamera c = (GreatCamera)((WeakReference)camera_ref).get();
        if (c == null)
            return;
    ...
    public interface AutoFocusCallback
    {
         ...
         */
        void onAutoFocus(boolean success, GreatCamera camera);
    }
     ...
     * it is a no-op and {@link AutoFocusCallback#onAutoFocus(boolean, GreatCamera)}
     ...
     * image capture with {@link #takePicture(GreatCamera.ShutterCallback,
     * GreatCamera.PictureCallback, GreatCamera.PictureCallback)}, will not change the
     ...
     *
     * @see #autoFocus(GreatCamera.AutoFocusCallback)
     */
    ...
    public interface AutoFocusMoveCallback
    {
         ...
         * @param camera the Camera service object
         */
        void onAutoFocusMoving(boolean start, GreatCamera camera);
    }
    ...
    public interface PictureCallback {
         ...
         * and {@link GreatCamera.Parameters} settings.
         *
         * @param data   a byte array of the picture data
         * @param camera the Camera service object
         */
        void onPictureTaken(byte[] data, GreatCamera camera);
    };
     ...
     * {@link GreatCamera.OnZoomChangeListener#onZoomChange(int, boolean, GreatCamera)}
...
//        }
    ...
    public interface OnZoomChangeListener
    {
         ...
         * @param camera  the Camera service object
         */
        void onZoomChange(int zoomValue, boolean stopped, GreatCamera camera);
    };
    ...
    public interface FaceDetectionListener
    {
         ...
         * @param camera  The {@link GreatCamera} service object
         */
        void onFaceDetection(Face[] faces, GreatCamera camera);
    }
     ...
     *
     * <p>After calling {@link #takePicture(GreatCamera.ShutterCallback, GreatCamera.PictureCallback,
     * GreatCamera.PictureCallback)} or {@link #stopPreview()}, and then resuming
    ...
    public interface ErrorCallback
    {
         ...
         * @param camera  the Camera service object
         */
        void onError(int error, GreatCamera camera);
    };
     ...
     * to {@link #setParameters(GreatCamera.Parameters)} to take effect.
     *
     * @see #setParameters(GreatCamera.Parameters)
     */
    ...
    public Parameters getParameters(String param) {
        Parameters p = new Parameters();
        p.unflatten(param);
        return p;
    }
    ...
    public static Parameters getEmptyParameters() {
        GreatCamera camera = new GreatCamera();
     ...
     * {@link GreatCamera#setParameters(GreatCamera.Parameters)}. For example, after
     * {@link GreatCamera.Parameters#setWhiteBalance} is called, white balance is not
     * actually changed until {@link GreatCamera#setParameters(GreatCamera.Parameters)}
     ...
     * should call {@link GreatCamera.Parameters#getSupportedColorEffects()} before
     * calling {@link GreatCamera.Parameters#setColorEffect(String)}. If the
     * camera does not support color effects,
     * {@link GreatCamera.Parameters#getSupportedColorEffects()} will return null.
     */
    public class Parameters {
         ...
         * call {@link #takePicture(GreatCamera.ShutterCallback,
         * GreatCamera.PictureCallback, GreatCamera.PictureCallback)} in this mode but the
         ...
         * {@link #takePicture(GreatCamera.ShutterCallback, GreatCamera.PictureCallback,
         * GreatCamera.PictureCallback, GreatCamera.PictureCallback)}. Using this hint can
         ...
         * can call {@link #takePicture(GreatCamera.ShutterCallback,
         * GreatCamera.PictureCallback, GreatCamera.PictureCallback,
         * GreatCamera.PictureCallback)} during recording. Applications do not need
         ...
         * {@link GreatCamera#takePicture takePicture}.</p>
         *
